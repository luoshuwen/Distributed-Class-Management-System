...
public class PrintDatabase
{
	...
	{
		File file = new File("/root/eclipse-workspace/distributedClient/Instant_DB");
		if (!file.exists())
		{
			file.mkdir();
		}
		...
		File file2 = new File("/root/eclipse-workspace/distributedClient/Instant_DB/" + name.trim()+"_record.txt");
		if (file2.exists())
		{		
			try
			{
            ...
            try  
            {              	
                out = new  BufferedWriter( new  OutputStreamWriter(    new  FileOutputStream("/root/eclipse-workspace/distributedClient/Instant_DB/"+ name.trim()+"_record.txt",  true )));  
		...
		file2 = new File("/root/eclipse-workspace/distributedClient/Instant_DB/" + name.trim()+"_course.txt");
		if (file2.exists())
		{		
			try
			{
            ...
            try  
            {              	
                out = new  BufferedWriter( new  OutputStreamWriter(    new  FileOutputStream("/root/eclipse-workspace/distributedClient/Instant_DB/"+ name.trim()+"_course.txt",  true )));  
