...
{
  private static String  _id = "IDL:CenterInterface/re:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CenterInterface.reHelper.id (), "re", __typeCode);
    }
    return __typeCode;
  }
