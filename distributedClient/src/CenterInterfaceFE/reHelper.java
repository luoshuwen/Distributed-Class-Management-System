...
/**
* CenterInterfaceFE/reHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from InterfaceMTL.idl
* Tuesday, August 1, 2017 10:00:22 PM EDT
*/

abstract public class reHelper
{
  private static String  _id = "IDL:CenterInterfaceFE/re:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (CenterInterfaceFE.reHelper.id (), "re", __typeCode);
    }
    return __typeCode;
  }
