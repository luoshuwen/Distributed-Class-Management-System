...
public class FeServer extends  InterfaceCenterPOA
{
	...
	public String createTRecord(String suc, String mi, String fn, String ln, String ad, String ph, String sp, String lo)
	{
		...
		FeUdp2Ask.udpAsk("next"+reqID, 36002);
		
		
		
		while(true)
		{
			System.out.println(FeHM.canuseresult[0]+"~~~~~~~~"+FeHM.canuseresult[1]+"~~~~~~~~~~~"+FeHM.canuseresult[2]);
			if(FeHM.canuseresult[0]==true&&FeHM.canuseresult[1]==true&&FeHM.canuseresult[2]==true)// hou xu chu li
			{
				...
				if(sucno==1)
				{
					if(FeHM.execute2Result[0]!=FeHM.execute2Result[1]&&FeHM.execute2Result[1]==FeHM.execute2Result[2])
